...
use rose_file_readers::{stb_column, QsdFile, QsdReadOptions, StbFile, QsdGameVersion, StbReadOptions, VfsIndex};
...
pub fn get_quest_database(vfs: &VfsIndex) -> Result<QuestDatabase, anyhow::Error> {
    ...
    let qsd_read_options = QsdReadOptions {
        game_version: QsdGameVersion::Narose667,
    };
    ...
    for row in 0..qsd_files_stb.rows() {
        ...
        match vfs.read_file_with::<QsdFile, _>(qsd_path, &qsd_read_options) {
