...
pub struct ClientStrings {
    ...
    pub skill_damage_type_continuous: &'static str,
    pub skill_damage_type_weapon: &'static str,
    pub skill_damage_type_magic: &'static str,
    pub skill_damage_type_natural_magic: &'static str,
