...
impl From<&str> for QuestTriggerHash {
    fn from(trigger_name: &str) -> Self {
...
impl QuestDatabase {
    ...
    pub fn get_trigger_by_hash(&self, hash: QuestTriggerHash) -> Option<&QuestTrigger> {
        self.triggers_by_hash
            .get(&hash)
            .and_then(|name| self.triggers.get(name))
    }
}
