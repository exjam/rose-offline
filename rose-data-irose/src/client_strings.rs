...
pub fn get_client_strings(
    ...
    Ok(Arc::new(ClientStrings {
        ...
        skill_damage_type_continuous: get_string(80),
        skill_damage_type_weapon: get_string(81),
        skill_damage_type_magic: get_string(82),
        skill_damage_type_natural_magic: get_string(83),
